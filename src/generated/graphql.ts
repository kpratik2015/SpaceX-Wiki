...
export type LaunchRocketFragment = { __typename?: 'Launch', rocket?: Maybe<{ __typename?: 'LaunchRocket', rocket_name?: Maybe<string>, rocket_type?: Maybe<string>, first_stage?: Maybe<{ __typename?: 'LaunchRocketFirstStage', cores?: Maybe<Array<Maybe<{ __typename?: 'LaunchRocketFirstStageCore', flight?: Maybe<number>, core?: Maybe<{ __typename?: 'Core', reuse_count?: Maybe<number>, status?: Maybe<string> }> }>>> }>, second_stage?: Maybe<{ __typename?: 'LaunchRocketSecondStage', payloads?: Maybe<Array<Maybe<{ __typename?: 'Payload', payload_type?: Maybe<string>, payload_mass_kg?: Maybe<number> }>>> }> }> };

export type LaunchRocketFirstStageFragment = { __typename?: 'LaunchRocket', first_stage?: Maybe<{ __typename?: 'LaunchRocketFirstStage', cores?: Maybe<Array<Maybe<{ __typename?: 'LaunchRocketFirstStageCore', flight?: Maybe<number>, core?: Maybe<{ __typename?: 'Core', reuse_count?: Maybe<number>, status?: Maybe<string> }> }>>> }> };

export type LaunchRocketSecondStageFragment = { __typename?: 'LaunchRocket', second_stage?: Maybe<{ __typename?: 'LaunchRocketSecondStage', payloads?: Maybe<Array<Maybe<{ __typename?: 'Payload', payload_type?: Maybe<string>, payload_mass_kg?: Maybe<number> }>>> }> };
...
export type PastLaunchesQuery = { __typename?: 'Query', launchesPast?: Maybe<Array<Maybe<{ __typename?: 'Launch', id?: Maybe<string>, mission_name?: Maybe<string>, launch_date_local?: Maybe<any>, launch_success?: Maybe<boolean>, launch_site?: Maybe<{ __typename?: 'LaunchSite', site_name_long?: Maybe<string> }>, links?: Maybe<{ __typename?: 'LaunchLinks', wikipedia?: Maybe<string> }>, rocket?: Maybe<{ __typename?: 'LaunchRocket', rocket_name?: Maybe<string>, rocket_type?: Maybe<string>, first_stage?: Maybe<{ __typename?: 'LaunchRocketFirstStage', cores?: Maybe<Array<Maybe<{ __typename?: 'LaunchRocketFirstStageCore', flight?: Maybe<number>, core?: Maybe<{ __typename?: 'Core', reuse_count?: Maybe<number>, status?: Maybe<string> }> }>>> }>, second_stage?: Maybe<{ __typename?: 'LaunchRocketSecondStage', payloads?: Maybe<Array<Maybe<{ __typename?: 'Payload', payload_type?: Maybe<string>, payload_mass_kg?: Maybe<number> }>>> }> }>, ships?: Maybe<Array<Maybe<{ __typename?: 'Ship', id?: Maybe<string>, name?: Maybe<string>, home_port?: Maybe<string>, image?: Maybe<string> }>>> }>>> };

export type ShipFragment = { __typename?: 'Launch', ships?: Maybe<Array<Maybe<{ __typename?: 'Ship', id?: Maybe<string>, name?: Maybe<string>, home_port?: Maybe<string>, image?: Maybe<string> }>>> };

export const LaunchRocketFirstStageFragmentDoc = `
  ...
  first_stage {
    ...
    `;
export const LaunchRocketSecondStageFragmentDoc = `
  ...
  second_stage {
    ...
    `;
export const LaunchRocketFragmentDoc = `
  ...
  rocket {
    ...
    ${LaunchRocketFirstStageFragmentDoc}
${LaunchRocketSecondStageFragmentDoc}`;
export const ShipFragmentDoc = `
  ...
  ships {
    ...
    `;
export const PastLaunchesDocument = `
    query PastLaunches($find: LaunchFind, $limit: Int, $offset: Int, $order: String, $sort: String) {
  launchesPast(
    find: $find
    limit: $limit
    order: $order
...
export const usePastLaunchesQuery = <
    ...
    useQuery<PastLaunchesQuery, TError, TData>(
      ['PastLaunches', variables],
      fetcher<PastLaunchesQuery, PastLaunchesQueryVariables>(PastLaunchesDocument, variables),
      options
    );
usePastLaunchesQuery.getKey = (variables?: PastLaunchesQueryVariables) => ['PastLaunches', variables];

usePastLaunchesQuery.fetcher = (variables?: PastLaunchesQueryVariables) => fetcher<PastLaunchesQuery, PastLaunchesQueryVariables>(PastLaunchesDocument, variables);